...
// This greatly helped me!: https://www.encodedna.com/javascript/filter-out-only-numbers-in-an-array-using-javascript.htm
...
const typeNum = (arr) => {
  ...
  let newArray = arr.filter(numbersOnly);
  return newArray;
};
...
const containsAnd = (arr) => {
  ...
  let newArray = arr.filter(andString);
  return newArray;
};
